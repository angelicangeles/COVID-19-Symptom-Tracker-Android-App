...
public class HealthHistory extends AppCompatActivity {
    ...
    private TextView tvHealthHistory;
    private DBHelper DB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvHealthHistory = findViewById(R.id.tvHealthHistory);
        btnDelete = findViewById(R.id.btnDelete);

        btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), DeleteSymptom.class);
    ...
    public void displayHealthHistory() {
        Cursor result = DB.getAllSymptoms(username, password);
        if (result.getCount() == 0) {
            Toast.makeText(HealthHistory.this, "No data found", Toast.LENGTH_LONG).show();
            return;
        }

        StringBuffer buffer = new StringBuffer();
        while (result.moveToNext()) {
            buffer.append("Symptom Report ID Number: " + result.getInt(0) + "\n\n");
        ...
        tvHealthHistory.setText(buffer.toString());

        //Show all data
        Toast.makeText(HealthHistory.this, "Data displayed", Toast.LENGTH_LONG).show();
    }
    ...
    public void ClickHealthHistory(View view){ recreate(); }
